...
',
    ...
    'v17development-flarum-seo.admin.permissions.configure_seo' => 'Allow configuring SEO',
    ...
    'v17development-flarum-seo.forum.controls.configure_seo' => 'Configure SEO',
    'v17development-flarum-seo.forum.controls.update_seo' => 'Update SEO',
    'v17development-flarum-seo.forum.controls.reset_seo' => 'Reset SEO',
...
',
    ...
    'kyrne-websocket.forum.discussion_list.show_updates_text' => '{count, plural, one {Show # updated discussion} other {Show # updated discussions}}',
    'kyrne-websocket.forum.discussion_page.viewing_title' => 'Here now:',
    'kyrne-websocket.forum.widget.title' => 'Online Users',
    'kyrne-websocket.forum.widget.empty' => 'No Users Currently Online.',
    'kyrne-websocket.forum.widget.guests' => '{count, plural, one {1 Guest} other {{count} Guests}}',
    'kyrne-websocket.admin.chart.title' => 'Websocket Statistics',
    'kyrne-websocket.admin.pusher_settings.local_cert_path' => 'Local SSL Certificate Path',
    'kyrne-websocket.admin.pusher_settings.local_pk_path' => 'Local SSL Private Key Path',
    'kyrne-websocket.admin.pusher_settings.passphrase' => '(Optional) SSL Key Passphrase',
    'kyrne-websocket.admin.pusher_settings.cert_self_signed' => 'Self-Signed Certificate Support',
    'kyrne-websocket.admin.pusher_settings.app_port_label' => 'Port',
    'kyrne-websocket.admin.pusher_settings.app_host_label' => 'Host',
    'kyrne-websocket.admin.pusher_settings.app_id_label' => 'App ID',
    'kyrne-websocket.admin.pusher_settings.auto_update' => 'Auto Update Discussions',
    'kyrne-websocket.admin.pusher_settings.app_key_label' => 'App Key',
    'kyrne-websocket.admin.pusher_settings.app_secret_label' => 'App Secret',
    'kyrne-websocket.admin.pusher_settings.stats_label' => 'Statistics Interval',
    'kyrne-websocket.admin.pusher_settings.secure' => 'Force wss/https for Websocket',
    'kyrne-websocket.admin.pusher_settings.title' => 'Websocket/Pusher Settings',
    'kyrne-websocket.admin.pusher_settings.reverse_proxy' => 'Reverse Proxy Support',
    'kyrne-websocket.admin.pusher_settings.auth_only' => 'Websocket for Logged in Users Only',
    'kyrne-websocket.admin.help.stats' => 'The time between statistics saves - in seconds. Recommended between 3600 (1 hour) and 21600 (6 hours) Default: 7200.',
    'kyrne-websocket.admin.help.auto_update' => 'Don\'t show the yellow update banner, immediately update the discussion list.',
    'kyrne-websocket.admin.help.app_id' => 'Pusher App ID - leave as is if using built-in websocket server.',
    'kyrne-websocket.admin.help.app_key' => 'Pusher App Key - leave as is if using built-in websocket server.',
    'kyrne-websocket.admin.help.secret' => 'Pusher App Secret - leave as is if using built-in websocket server.',
    'kyrne-websocket.admin.help.secure' => 'Force the websocket to use secure protocols - Enable this if you are using a secure websocket server but not website.',
    'kyrne-websocket.admin.help.host' => 'Host of your websocket server - leave as is if the server is the same host as your admin.',
    'kyrne-websocket.admin.help.reverse_proxy' => 'Websockets will connect over port 443 when this is enabled - Use this if you are using a reverse proxy from port 443 to your websocket server.',
    'kyrne-websocket.admin.help.port' => 'Port of your websocket server - leave as is if you don\'t change the build in server port.',
    'kyrne-websocket.admin.help.cert_path' => 'Only needed if using ssl and NOT reverse proxy. Path to your SSL (https) certificate ON THE SERVER your websocket server is on - usually a .crt or .pem file.',
    'kyrne-websocket.admin.help.pk_path' => 'Only needed if using ssl and NOT reverse proxy. Path to your SSL (https) private key ON THE SERVER your websocket server is on - usually a .key or .pem file.',
    'kyrne-websocket.admin.help.passphrase' => 'Only needed if using ssl and NOT reverse proxy. The passphrase used to encode your certificate - not usually needed.',
    'kyrne-websocket.admin.help.self_signed' => 'Only needed if using ssl and NOT reverse proxy. Enable this if your SSL (https) certificate is self-signed.',
    'kyrne-websocket.admin.help.auth_only' => 'Only allow authenticated users to connect to the websocket server, can reduce the CPU load.',
    'justoverclock-og-meta-tag.admin.siteName' => 'Site Name',
    'justoverclock-og-meta-tag.admin.siteName-help' => 'If your object is part of a larger web site, the name which should be displayed for the overall site. e.g., "IMDb".',
    'justoverclock-og-meta-tag.admin.ogimage' => 'Open Graph Image',
    'justoverclock-og-meta-tag.admin.ogimage-help' => 'An image URL which should represent your object within the graph.',
    'justoverclock-og-meta-tag.admin.ogdesc' => 'Open Graph Description',
    'justoverclock-og-meta-tag.admin.ogdesc-help' => 'A one to two sentence description of your website.',
    'justoverclock-og-meta-tag.admin.ogtitle' => 'Open Graph Title',
    'justoverclock-og-meta-tag.admin.ogtitle-help' => 'The title of your object as it should appear within the graph, e.g., "The Rock".',
    'justoverclock-og-meta-tag.admin.ogurl' => 'Open Graph Url',
    'justoverclock-og-meta-tag.admin.ogurl-help' => 'The canonical URL of your object that will be used as its permanent ID in the graph, e.g., "https://www.imdb.com/title/tt0117500/".',
    ...
    'fof-username-request.email.body.noReasonProvided' => 'No reason provided.',
    'fof-username-request.email.body.approved' => 'Hello {recipient_display_name},
...
',
    'fof-username-request.email.body.rejected' => 'Hello {recipient_display_name},

Your request to change your username from "{old_username}" to "{requested_username}" has been rejected by {actor_display_name}.

Reason: {reason}
',
    'fof-username-request.email.subject.approved' => '{display_name} approved your username change to {requested_username}',
    'fof-username-request.email.subject.rejected' => '{display_name} rejected your username change to {requested_username}',
...
',
    ...
    'flarum-gdpr.lib.data.masqueradeanswers.export_description' => 'Exports the user\'s profile field answers',
    'flarum-gdpr.lib.data.masqueradeanswers.delete_description' => 'Removes all profile field answers from the user\'s account',
    'flarum-gdpr.lib.data.masqueradeanswers.anonymize_description' => '=> flarum-gdpr.lib.data.masqueradeanswers.delete_description',
...
',
    ...
    'clarkwinkelmann-formatted-banner.admin.settings.guestContent' => 'Guest Formatted Content',
    'clarkwinkelmann-formatted-banner.admin.settings.guestHtml' => 'Guest HTML Content',
    'clarkwinkelmann-formatted-banner.admin.settings.memberContent' => 'Member Formatter Content',
    'clarkwinkelmann-formatted-banner.admin.settings.memberHtml' => 'Member HTML Content',
    'clarkwinkelmann-formatted-banner.admin.settings.dismissible' => 'Allow dismissing banner',
    'clarkwinkelmann-formatted-banner.admin.settings.replaceWelcomeHero' => 'Replace Welcome Hero with banner',
    'clarkwinkelmann-formatted-banner.admin.settings.hideWelcomeHero' => 'Hide Welcome Hero',
    'clarkwinkelmann-formatted-banner.forum.alert.refresh' => 'Refresh page',
    'clarkwinkelmann-formatted-banner.forum.alert.login' => 'You have been connected automatically.',
    'clarkwinkelmann-formatted-banner.forum.alert.logout' => 'Your session has expired.',
    'afrux-forum-stats-widget.forum.widget.stats.comment_post_count' => 'Posts',
    'afrux-forum-stats-widget.forum.widget.stats.discussion_count' => 'Discussions',
    'afrux-forum-stats-widget.forum.widget.stats.user_count' => 'Users',
    'afrux-forum-stats-widget.forum.widget.title' => 'Forum Stats',
